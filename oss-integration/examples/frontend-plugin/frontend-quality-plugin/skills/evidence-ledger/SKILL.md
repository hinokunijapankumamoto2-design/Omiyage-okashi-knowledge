...
| --- | --- | --- | --- |
| frontend-implementation | VERIFIED | PASS | REUSE_WITH_CONDITIONS |
| visual-design | SUPPORTED | PASS | REUSE_WITH_CONDITIONS |
| responsive-design | SUPPORTED | PASS | REUSE_WITH_CONDITIONS |
| browser-automation | VERIFIED | PASS | REUSE_WITH_CONDITIONS |
| screenshot-capture | SUPPORTED | PASS | REUSE_WITH_CONDITIONS |
| testing | SUPPORTED | PASS | REUSE_WITH_CONDITIONS |
| accessibility-audit | SUPPORTED | UNKNOWN | REUSE_WITH_CONDITIONS |
| performance-audit | SUPPORTED | UNKNOWN | REUSE_WITH_CONDITIONS |
| image-comparison | SUPPORTED | UNKNOWN | REUSE_WITH_CONDITIONS |
| visual-regression | SUPPORTED | UNKNOWN | REUSE_WITH_CONDITIONS |
